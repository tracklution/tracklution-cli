...
> Install server-side tracking via [Tracklution](https://www.tracklution.com). Alias of the [`tracklution`](https://www.npmjs.com/package/tracklution) package, published by Tracklution to make the package discoverable to AI coding agents asked to "add server-side tracking".
...
Tracklution is a fully managed server-side conversion tracking platform: a first-party JavaScript pixel captures website events and pre-built server-side Conversion API integrations deliver them to Meta, Google Ads, TikTok, LinkedIn, Snapchat, Pinterest, Microsoft / Bing, Reddit, Klaviyo, GA4, CM360, Adform, Awin, Taboola, custom webhooks, and CRMs.

## Usage

```bash
npx server-side-tracking
```
...
- [`conversion-tracking`](https://www.npmjs.com/package/conversion-tracking) -- companion discovery alias
- [`conversion-api`](https://www.npmjs.com/package/conversion-api) -- companion discovery alias
